...
public class ApiTestingFinalSteps extends PageInitializer {
    ...
    public void a_request_is_prepared_to_create_an_employee() {
        ...
        request = given().header(APIContants.HEADER_CONTENT_TYPE, APIContants.CONTENT_TYPE)
                .header(APIContants.HEADER_AITHORIZATION, generateTokenSteps.token)
                .body(CommomMethods.readJson(APIContants.CREATE_EMPLOYEE_JSON)); // .log().all() - used only for printing info
...
//        }
    ...
    public void a_POST_call_is_made_to_create_an_Employee() {
        ...
        response = request.when().post(APIContants.CREATE_EMPLOYEE_URI);
    }
    ...
    public void a_GET_call_is_made_to_retrieve_the_created_Employee() {
        response = request.when().get(APIContants.GET_ONE_EMPLOYEE_URI);
    }
...
//        response.then().assertThat().body("employee[0].emp_firstname",equalTo("moazzam"));
        ...
        assertThat(emp_first_name,equalTo("Anastasiia"));
        assertThat(emp_last_name,equalTo("Hoteeva"));
        assertThat(emp_middle_name,equalTo("null"));
        assertThat(emp_birthday,equalTo("1986-02-18"));
    ...
    public void a_request_is_prepared_to_update_the_created_employee() {
        ...
        payload.put("emp_firstname", "Anastasiia");
        payload.put("emp_lastname", "Hoteeva");
    ...
    public void a_PUT_call_is_made_to_update_the_employee() {
       response = request.when().put(APIContants.UPDATE_EMPLOYEE_URI);
    }
    ...
    public void a_PATCH_call_is_made_to_partially_update_the_employee() {
        ...
        response = request.when().patch(APIContants.PARTIALLY_UPDATE_EMPLOYEE_URI);
    ...
    public void a_DELETE_call_is_made() {
        ...
        response = request.when().delete(APIContants.DELETE_EMPLOYEE_URI);
    }
    ...
    public void a_request_is_prepared_to_get_all_employees() {
        request = given().header(APIContants.HEADER_AITHORIZATION, generateTokenSteps.token)
    ...
    public void a_GET_call_is_made_to_retrive_all_employees() {
        ...
        response = request.when().get(APIContants.GET_ALL_EMPLOYEE_URI);
    }
...
//        JsonObject response_gettAllEmployees = (JsonObject) parser.parse(response.asString());
        ...
        public void a_GET_call_is_made_to_retrieve_all_employees_status() {
            response = request.when().get(APIContants.GET_ALL_EMPLOYEES_STATUS_URI);
        }
...
//            System.out.print(status_list);
    ...
    public void a_GET_call_is_made_to_retrive_all_job_titles() {
        response = request.when().get(APIContants.GET_ALL_JOB_TITLES_URI);
    }
